  ...
  return (
    <div className="border-t border-[var(--ds-border)] bg-[var(--ds-bg)]">
      <div className="max-w-4xl mx-auto px-3 md:px-4 py-2.5 md:py-3">
        ...
        {/* Input area */}
        <div className="flex items-end gap-2 bg-[var(--ds-bg-tertiary)] rounded-2xl border border-[var(--ds-border)] focus-within:border-[var(--ds-accent)] transition-colors duration-200 px-3 md:px-4 py-2">
          <textarea
            ref={textareaRef}
            value={input}
