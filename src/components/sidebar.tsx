...
import {
  ...
  PanelRightOpen, PanelRightClose, Download, Upload,
} from 'lucide-react'
...
export function Sidebar({
  ...
  if (collapsed) {
    return (
      <div className="flex flex-col items-center py-3 px-1 bg-[var(--ds-bg-secondary)] border-r border-[var(--ds-border)]">
        <button
  ...
  return (
    <div className="flex flex-col h-full w-64 bg-[var(--ds-bg-secondary)] border-r border-[var(--ds-border)]">
      {/* Header */}
      ...
      <div className="px-3 py-2 border-t border-[var(--ds-border)] space-y-1">
        ...
        {/* DeepSeek official website button */}
        <button
          onClick={() => onViewModeChange(viewMode === 'chat' ? 'deepseek' : 'chat')}
          className={cn(
